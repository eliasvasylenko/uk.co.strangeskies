...
public abstract class LocalizedError extends Error {
	 ...
	 *          the cause
	 */
	public LocalizedError(Localized<String> message, Locale developerLocale, Throwable cause) {
	 ...
	 *          the developer's locale
	 */
	public LocalizedError(Localized<String> message, Locale developerLocale) {
	 ...
	 *          the cause
	 */
	public LocalizedError(Localized<String> message, Throwable cause) {
	 ...
	 *          the localized message string
	 */
	public LocalizedError(Localized<String> message) {
