...
public abstract class LocalizedRuntimeException extends RuntimeException {
	 ...
	 *          the cause
	 */
	public LocalizedRuntimeException(Localized<String> message, Locale developerLocale, Throwable cause) {
	 ...
	 *          the developer's locale
	 */
	public LocalizedRuntimeException(Localized<String> message, Locale developerLocale) {
	 ...
	 *          the cause
	 */
	public LocalizedRuntimeException(Localized<String> message, Throwable cause) {
	 ...
	 *          the localized message string
	 */
	public LocalizedRuntimeException(Localized<String> message) {
