...
public class Scaling<O> extends BinaryExpression<Scaling<O>, Scalable<? extends O>, Value<?>, O> {
	...
	@Override
	public Scaling<O> copy() {
		return new Scaling<>(getFirstOperand(), getSecondOperand());
	}
}
