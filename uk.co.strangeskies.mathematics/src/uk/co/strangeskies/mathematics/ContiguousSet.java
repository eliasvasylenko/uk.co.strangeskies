...
public class ContiguousSet<T> implements Iterable<T>, Collection<T>, NavigableSet<T>, SortedSet<T> {
  ...
  public static <T extends Incrementable<? extends T>> ContiguousSet<T> create(Range<T> range) {
  ...
  public Iterator<T> iterator() {
    return new Iterator<T>() {
      T on = getRange().isFromInclusive()
          ? getRange().getFrom()
          : incrementor.increment(getRange().getFrom());
  ...
  public ContiguousSet<T> subSet(T from, boolean fromInclusive, T to, boolean toInclusive) {
    ...
    return new ContiguousSet<>(
        new Range<>(fromRounded, fromInclusive, toRounded, toInclusive, getComparator()),
        getIncrementor());
  }
