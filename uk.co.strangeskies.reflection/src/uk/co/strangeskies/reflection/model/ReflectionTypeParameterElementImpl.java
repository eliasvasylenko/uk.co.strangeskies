...
public class ReflectionTypeParameterElementImpl extends ReflectionElementImpl
  ...
  public ReflectionElement getEnclosingElement() {
    if (source instanceof Class)
      return CoreReflectionFactory.createMirror((Class<?>) source);
    else if (source instanceof Method)
      return CoreReflectionFactory.createMirror((Method) source);
    else if (source instanceof Constructor)
      return CoreReflectionFactory.createMirror((Constructor<?>) source);
    else
