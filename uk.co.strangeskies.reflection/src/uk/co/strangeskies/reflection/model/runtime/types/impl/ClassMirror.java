...
public class ClassMirror extends RuntimeTypeMirrorImpl implements RuntimeDeclaredType {
  public ClassMirror(Class<?> source) {
    super(DeclaredType);
  }
  ...
  boolean isSameType(DeclaredType other) {
    if (other instanceof ClassMirror) {
      return Objects.equals(getSource(), ((ClassMirror) other).getSource());
    } else {
      return false;
    }
  }
