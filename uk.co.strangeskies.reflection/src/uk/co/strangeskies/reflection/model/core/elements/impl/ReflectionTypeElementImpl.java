...
public class ReflectionTypeElementImpl extends ReflectionElementImpl
  ...
  private void addMembers(
    ...
    for (Field f : cls.getDeclaredFields()) {
      ...
      ReflectionElement tmp = CoreReflectionFactory.asMirror(f);
      boolean add = true;
    ...
    for (Method m : cls.getDeclaredMethods()) {
      ...
      ReflectionExecutableElement tmp = CoreReflectionFactory.asMirror(m);
      boolean add = true;
    ...
    for (Class<?> c : cls.getDeclaredClasses()) {
      ...
      ReflectionElement tmp = CoreReflectionFactory.asMirror(c);
      boolean add = true;
