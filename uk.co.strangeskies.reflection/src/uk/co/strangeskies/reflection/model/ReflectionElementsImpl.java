...
class ReflectionElementsImpl implements ReflectionElements {
  ...
  public ReflectionPackageElement getPackageElement(CharSequence name) {
    return CoreReflectionFactory.createMirror(Package.getPackage(name.toString()));
  }
  ...
  public ReflectionTypeElement getTypeElement(CharSequence name) {
    ...
    do {
      again = false;
      try {
        tmp = CoreReflectionFactory.createMirror(Class.forName(n));
   ...
   */
  @Override
  public Map<? extends ReflectionExecutableElement, ? extends AnnotationValue> getElementValuesWithDefaults(
      AnnotationMirror a) {
  ...
  public boolean isDeprecated(Element e) {
    checkElement(e);
    return ((ReflectionElementImpl) e)
        .getSource()
  ...
  public ReflectionPackageElement getPackageOf(Element type) {
    ...
    if (type instanceof ReflectionTypeElementImpl) {
      ...
      ReflectionTypeElementImpl enclosingTypeElement = (ReflectionTypeElementImpl) getEnclosingTypeElement(
          (ReflectionElement) type);
      p = enclosingTypeElement.getSource().getPackage();
    }

    return CoreReflectionFactory.createMirror(p);
  }
  ...
  public ReflectionTypeElement getEnclosingTypeElement(ReflectionElement e) {
    ...
    if (e instanceof ReflectionTypeParameterElementImpl) {
      ReflectionElement encElem = ((ReflectionTypeParameterElementImpl) e).getEnclosingElement();
    ...
    return encl == null ? null : CoreReflectionFactory.createMirror(encl);
  }
  ...
  private boolean overridesDirect(
    ...
    if (!CoreReflectionFactory.getTypes().isSubtype(riderType.asType(), getEnclosingTypeElement(ridden).asType())) {
      return false;
    }
  ...
  private static class Constants {
    ...
    public static String format(Object value) {
      ...
      if (value instanceof Integer || value instanceof Boolean)
        ...
        throw new IllegalArgumentException(
            "Argument is not a primitive type or a string; it " + ((value == null)
                ? "is a null value."
