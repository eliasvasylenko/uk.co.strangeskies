 ...
 */
package uk.co.strangeskies.reflection.matchers;
...
public class IsSubtypeOf extends BaseMatcher<Type> {
	...
	public boolean matches(Object item) {
		return (item == null || item instanceof Type) && TypesOLD.isSubtype((Type) item, assignmentTarget);
	}

	@Override
	public void describeTo(Description description) {
		description.appendText(" subtype of " + new TypeGrammar(Imports.empty()).toString(assignmentTarget));
	}
}
