...
/**
 * Create a requirement on the {@value RequireRubyScriptEngine#LANGUAGE} scripting engine.
 * 
 * @author Elias N Vasylenko
 */
@RequireCapability(
		ns = CAPABILITY_NAMESPACE,
		filter = "(" + CAPABILITY_LANGUAGE_FILTER + "=" + RequireRubyScriptEngine.LANGUAGE + ")")
public @interface RequireRubyScriptEngine {
