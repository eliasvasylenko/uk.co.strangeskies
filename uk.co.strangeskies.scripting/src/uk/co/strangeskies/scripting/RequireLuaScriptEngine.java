...
/**
 * Create a requirement on the {@value RequireLuaScriptEngine#LANGUAGE} scripting engine.
 * 
 * @author Elias N Vasylenko
 */
@RequireCapability(
		ns = CAPABILITY_NAMESPACE,
		filter = "(" + CAPABILITY_LANGUAGE_FILTER + "=" + RequireLuaScriptEngine.LANGUAGE + ")")
public @interface RequireLuaScriptEngine {
