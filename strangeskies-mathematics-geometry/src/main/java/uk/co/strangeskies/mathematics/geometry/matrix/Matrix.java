...
public interface Matrix<S extends Matrix<S, V>, V extends Value<V>> extends
	...
	public S setData(Order order, Value<?>... to);

	public S setData(Value<?>... to);

	public S setData2(Order order, List<? extends List<? extends Value<?>>> to);

	public S setData2(List<? extends List<? extends Value<?>>> to);

	public S setData(Order order, List<? extends Value<?>> to);

	public S setData(List<? extends Value<?>> to);
