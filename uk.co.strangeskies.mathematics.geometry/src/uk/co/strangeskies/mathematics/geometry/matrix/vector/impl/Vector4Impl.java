...
public class Vector4Impl<V extends Value<V>> extends VectorImpl<Vector4<V>, V>
	...
	public Vector4Impl(Order order, Orientation orientation, Supplier<V> valueFactory) {
		super(4, order, orientation, valueFactory);
	}

	public Vector4Impl(Order order, Orientation orientation, List<? extends V> values) {
	...
	public Vector4<V> copy() {
		return new Vector4Impl<>(getOrder(), getOrientation(), getData());
	}
}
