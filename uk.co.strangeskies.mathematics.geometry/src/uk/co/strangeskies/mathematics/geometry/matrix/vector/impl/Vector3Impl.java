...
public class Vector3Impl<V extends Value<V>> extends VectorImpl<Vector3<V>, V>
	...
	public Vector3Impl(Order order, Orientation orientation, Supplier<V> valueFactory) {
		super(3, order, orientation, valueFactory);
	}

	public Vector3Impl(Order order, Orientation orientation, List<? extends V> values) {
	...
	public Vector3<V> copy() {
		return new Vector3Impl<>(getOrder(), getOrientation(), getData());
	}
}
